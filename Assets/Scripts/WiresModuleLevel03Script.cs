...
public class WiresModuleLevel03Script : MonoBehaviour
{
    ...
    public void OnMouseDown()
    {
        ...
        else if (bombIndex == 2)
        {
            if (gm.wiresFinal == false)
            {
                if (this.gameObject.name == "YellowWire02")
                {
                    Cursor.SetCursor(null, Vector2.zero, CursorMode.Auto);
                    wiresIndicator.GetComponent<MeshRenderer>().material = indicatorPassed;
                    numberOfModules++;
                ...
                else if (this.gameObject.name == "YellowWire01")
                {
                    Cursor.SetCursor(null, Vector2.zero, CursorMode.Auto);
                    YellowWire.SetActive(false);
                    YellowWireCut.SetActive(true);
        ...
        else if (bombIndex == 3)
        {
            if (gm.wiresFinal == false)
            {
                ...
                else if (this.gameObject.name == "YellowWire")
                {
                    Cursor.SetCursor(null, Vector2.zero, CursorMode.Auto);
                    YellowWire.SetActive(false);
                    YellowWireCut.SetActive(true);
