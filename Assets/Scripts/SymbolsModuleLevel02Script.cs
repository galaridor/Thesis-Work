...
public class SymbolsModuleLevel02Script : MonoBehaviour
{
       ...
       strikes = gm.levelTwoStrikes;
        ...
        if (bombIndex == 1)
        {
            if (gm.symbolsFinal == false)
            {
                if (strikes == 0)
                {
                    if (this.gameObject.name == "Symbol03")
                    {
                        if (counter == 3)
                        {
                            Cursor.SetCursor(null, Vector2.zero, CursorMode.Auto);
                    ...
                    else if (this.gameObject.name == "Symbol01")
                    {
                        if (counter == 2)
                        {
                            Cursor.SetCursor(null, Vector2.zero, CursorMode.Auto);
        ...
        else if (bombIndex == 2)
        {
            if (gm.symbolsFinal == false)
            {
                if (strikes == 0)
                {
                    if (this.gameObject.name == "Symbol04")
                    {
                        if (counter == 1)
                        {
                            Cursor.SetCursor(null, Vector2.zero, CursorMode.Auto);
        ...
        else if (bombIndex == 3)
        {
            if (gm.symbolsFinal == false)
            {
                if (strikes == 0)
                {
                    if (this.gameObject.name == "Symbol02")
                    {
                        if (counter == 1)
                        {
                            Cursor.SetCursor(null, Vector2.zero, CursorMode.Auto);
